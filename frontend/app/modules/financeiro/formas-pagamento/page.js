    ...
    try {
      ...
      if (response.ok && data.success !== false) {
        ...
        mensagem.innerHTML = `
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium">Forma de pagamento ${editingId ? 'atualizada' : 'cadastrada'} com sucesso!</p>
            </div>
          </div>
        `;
        ...
        mensagem.innerHTML = `
          <div class="flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium">${data.error || 'Erro ao salvar forma de pagamento'}</p>
            </div>
          </div>
        `;
        document.body.appendChild(mensagem);
      ...
      mensagem.innerHTML = `
        <div class="flex items-center">
          ...
          <div class="ml-3">
            <p class="text-sm font-medium">Erro ao salvar forma de pagamento: ${error.message}</p>
          </div>
        </div>
      `;
      document.body.appendChild(mensagem);
